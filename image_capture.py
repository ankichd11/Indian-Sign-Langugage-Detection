...
while(True):
    ...
    if(CAPTURE_FLAG):
        if(count<400):
            ...
            frame = cv2.putText(frame, 'Capturing..', (50,70), cv2.FONT_HERSHEY_SIMPLEX, 1.5, (0,255,0), 2, cv2.LINE_AA)
            ...
            break
    frame = cv2.putText(frame, str(count), (50,450), cv2.FONT_HERSHEY_SIMPLEX, 2, (0,255,0), 2, cv2.LINE_AA)
